# 서울 수도권 전철 전체 역명 (2025 기준)
# 1호선~9호선 + 신분당선 + 분당선 + 경의중앙선 + 공항철도 + 우이신설선 포함
...
STATION_NAMES = [
    ...
    "영등포","신도림","구로","구일","개봉","오류동","온수","역곡","부천","중동",
    ...
    "왕십리","한양대","뚝섬","성수","건대입구","구의","강변","잠실나루","잠실","종합운동장",
    "삼성","선릉","역삼","강남","교대","서초","방배","사당","낙성대","서울대입구","봉천",
    "신림","신대방","구로디지털단지","대림","신도림","문래","영등포구청","당산","합정",
    "홍대입구","신촌","이대","아현","충정로",
    ...
    # 6호선
    # -------------------------
    "봉화산","화랑대","태릉입구","석계","돌곶이","상월곡","월곡","고려대","안암","보문",
    "창신","동묘앞","신설동","제기동","청량리",
    ...
    "뚝섬유원지","청담","논현","반포","고속터미널","내방","총신대입구","남성","숭실대입구",
    ...
    "영통","망포","매탄권선","수원시청","매교","수원",

    # -------------------------
    # 신분당선
    # -------------------------
    "강남","양재","양재시민의숲","청계산입구","판교","정자","동천","수지구청","성복",
    "상현","광교중앙","광교",

    # -------------------------
    # 경의·중앙선
    # -------------------------
    "용문","원덕","양평","오빈","아신","국수","신원","양수","운길산","팔당","도심",
    "덕소","양정","도농","구리","양원","망우","상봉","중랑","회기","청량리",
    "응봉","옥수","한남","서빙고","이촌","용산","효창공원앞",

    # -------------------------
    # 공항철도
    # -------------------------
    "서울역","공덕","홍대입구","디지털미디어시티","마곡나루","김포공항","계양",
    "검암","청라국제도시","영종","운서","공항화물청사","인천공항터미널","인천공항2터미널",

    # -------------------------
    # 우이신설선
    # -------------------------
    "북한산우이","솔밭공원","4.19민주묘지","가오리","화계","삼양","삼양사거리",
    "솔샘","북한산보국문","정릉","성신여대입구","보문"
